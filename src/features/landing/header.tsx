    ...
    return (
        <>
            <nav className="relative items-center py-5 sm:px-0 mx-auto max-w-screen-xl md:flex md:space-x-6 bg-sky-800">
                ...
                <ul className={`flex-1 justify-between mt-4 md:text-sm md:font-medium md:flex md:mt-0 ${state ? 'absolute inset-x-0 px-4 border-b bg-sky-800 md:border-none md:static' : 'hidden'}`}>
                ...
                <div className="max-w-screen-xl mx-auto md:px-0 px-4 text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex ">
                    <div className="flex-none space-y-5 sm:max-w-lg md:px-0 lg:max-w-xl">
                        ...
                        <div className="items-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
                            ...
                            <Link href="/students" className="flex items-center justify-center gap-x-2 py-2 px-4 text-gray-700 hover:text-gray-500 font-medium duration-150 active:bg-gray-100 border rounded-lg md:inline-flex">
                                {`Manage students`}
